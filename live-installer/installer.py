    ...
    def start_installation(self):
        ...
        if self.setup.grub_device:
            ...
            if self.setup.gptonefi:
                ...
                os.system("cp /run/live/medium/pool/main/g/grub2/grub-pc* /target/debs/") 
        ...
        with open("/usr/lib/live-installer/resources/filesystem.packages-remove", "r") as fd:
